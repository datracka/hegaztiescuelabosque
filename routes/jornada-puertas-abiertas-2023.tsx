  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="El próximo mes, los dias 21 y 22 de Abril, tendremos una jornada de puertas abiertas para que puedas conocer nuestra escuela y nuestro proyecto educativo."
        />
      </Head>
      <NavBar />
      <Hero
