...
export default function politicaDePrivacidad() {
  return (
    <>
      ...
      >
        <h1 className={tw(`hegazti-h1 py-8`)}>
          POLÍTICA DE PRIVACIDAD
        </h1>
        <h3 className={tw(`text-2xl pt-8 pb-4`)}>INTRODUCCIÓN</h3>
        <p className={tw(`mb-4`)}>
        ...
        <h3 className={tw(`text-2xl pt-8 pb-4`)}>FINALIDAD DEL TRATAMIENTO:</h3>
        <p className={tw(`mb-4`)}>
        ...
        <p className={tw(`mb-4`)}>
          ...
          caminandoconcaballos20@gmail.com, indicando como Asunto: "PROTECCIÓN
        ...
        <h3 className={tw(`text-2xl pt-8 pb-4`)}>INFORMACIÓN ADICIONAL</h3>
        <p className={tw(`mb-4`)}>
        ...
        <p className={tw(`mb-4`)}>
          ...
          sean los contenidos que ASOCIACIÓN PARA EL DESARROLLO DE LAS TERAPIAS
          ECUESTRES CAMINANDO CON CABALLOS considere inapropiados.
        </p>
        <p className={tw(`mb-4`)}>
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <p className={tw(`mb-4`)}>
          ...
          social, ASOCIACIÓN PARA EL DESARROLLO DE LAS TERAPIAS ECUESTRES
          CAMINANDO CON CABALLOS quedará exento de responsabilidad en relación
