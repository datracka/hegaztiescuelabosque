  ...
  return (
    <>
      ...
      >
        ...
        <h3 className={tw(`text-2xl pt-8 pb-4`)}>¿QUÉ SON LAS COOKIES?</h3>
        <p className={tw(`mb-4`)}>
        ...
        <h3 className={tw(`text-2xl pt-8 pb-4`)}>TIPO DE COOKIES</h3>
        <p className={tw(`mb-4`)}>
        ...
        <h3 className={tw(`text-2xl pt-8 pb-4`)}>COOKIES EXENTAS:</h3>
        <p className={tw(`mb-4`)}>
        ...
        <p className={tw(`mb-4`)}>
          ...
          Navarra y con CIF G26525329. Teléfono 669 575 406 y mail de contacto
          {" "}
          <a href="mailto:caminandoconcaballos20@gmail.com">
